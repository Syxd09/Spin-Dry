  ...
  return (
    <span className="flex items-center gap-3">
      <img
        src="/logo.png"
        alt="Spin & Dry Logo"
        className={compact ? "size-8 rounded-full object-cover border border-brass/50 shadow-xs" : "size-14 rounded-full object-cover border-2 border-brass/60 shadow-md"}
      />
